const event_json = `{
  "intro_qsdokx": {
    ...
    "dialogue": [
        "Bonjour fameux aventuriers, <br>Je suis le Professeur Martin, archéologue en chef.<br>Mais commençons d'abord par les bases de cet outil, <br><b>veuillez cliquer sur la flèche pour afficher la suite...</b>",
